      ...
      <div className="min-h-screen bg-page flex items-center justify-center p-4 pt-32 pb-20">
        ...
        <div className="bg-surface-1 rounded-2xl shadow-2xl p-8 border border-white/5">
          ...
          <p className="text-gray-400 text-center mb-8">
            Únete a miles de estudiantes y comienza tu aprendizaje
          </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex items-start gap-2">
              <input
                id="terms"
                type="checkbox"
                className="mt-1 w-4 h-4 rounded border-gray-700 bg-surface-2 text-primary focus:ring-primary focus:ring-offset-0"
                required
              />
