    ...
    <section className="relative min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8 pt-24 pb-16 overflow-x-hidden">
      ...
      <div 
        ...
        style={{
          ...
          backgroundPosition: 'right top, 85% 3%, 80% 8%, 78% 10%, right -5% top',
          height: '110vh',
          width: '140%',
          filter: 'blur(100px)',
          top: '-150px',
      ...
      <div className="max-w-6xl w-full">
        ...
        <div className="text-center mb-12 sm:mb-16">
          ...
          {/* Question */}
          <p className="text-lg sm:text-xl md:text-2xl text-white mb-6 sm:mb-8 font-medium px-4">
          ...
          <div className="max-w-2xl mx-auto px-4">
            <div className="relative">
              <input
                type="text"
                placeholder="Inglés"
                className="w-full bg-[#1a1e26] text-white placeholder-gray-400 px-6 py-4 sm:py-5 rounded-xl border border-white/10 focus:outline-none focus:border-primary transition-colors text-base sm:text-lg shadow-xl"
              />
              <button className="absolute right-2 top-1/2 -translate-y-1/2 bg-primary hover:bg-primary/90 p-3 rounded-lg transition-colors">
